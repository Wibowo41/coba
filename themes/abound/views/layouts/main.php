...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Recruitment New Armada</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="ahrms themes development">
    <meta name="author" content="newarmada.co.id">
    ...
    <link rel="icon" type="image/png" size="32x32" href="<?php echo Yii::app()->request->baseUrl; ?>/assets/ico/favicon-32x32.png" type="image/x-icon" /> 
