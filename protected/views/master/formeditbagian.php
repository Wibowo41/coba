...
$query= Yii::app()->db->createCommand("SELECT * FROM master_bagian WHERE id_wo = '$idproses'")->queryAll();
                ...
                <div class="col-md-4">
                    <div class="form-group row">
                        <div class="col-sm-12">
                            ...
                            <input type="text" value="<?php echo $array[]=$row['code_master_proses']; ?>" name="proses" class="form-control" placeholder="Code Proses">
                        </div>
                    </div>
                </div>
