        ...
        <script type="text/javascript">
            $(document).ready(function(){
                Swal.fire({
                    ...
                    window.location = "index.php?r=master/proses";
                });
            });
        </script>
        <?php
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                Swal.fire({
                    ...
                    text: 'Proses sudah pernah dibuat',
                  }).then((result) => {
                    window.location = "index.php?r=master/proses";
                });
            });
...
<form action="index.php?r=master/prosescreateproses" method="post">
                ...
                <div class="col-md-4">
                    <div class="form-group row">
                        <div class="col-sm-12">
                            ...
                            <input type="text" name="proses" class="form-control" placeholder="Code Proses" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group row">
                        <div class="col-sm-12">
                            ...
                            <input type="text" name="keteranganproses" class="form-control" placeholder="Keterangan Proses" required>
                        </div>
                    </div>
                </div>
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        ?>
                        <tr>
                            <td><?php echo $array[]=$row['code_master_proses']; ?></td>
                            ...
                            <td>
                                <a href="index.php?r=master/formeditproses&auth=<?php echo $this->base64_encrypt($array[]=$row['id_master_bagian'], $this->key()); ?>" class="btn btn-dark btn-icon-text btn-sm">
                                    Edit
                                    <i class="ti-pencil btn-icon-append"></i>                          
                                </a>
                                
                                <!--<a class="btn btn-danger btn-icon-text btn-sm" id="submitdelete" auth="<?php //echo $this->base64_encrypt($array[]=$row['id_master_bagian'], $this->key()); ?>">
                                    Delete
...
$(document).on('click', '#submitdelete', function(){
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        window.location = "index.php?r=master/prosesdeleteproses&auth="+id;
      } 
    });
});
</script>
