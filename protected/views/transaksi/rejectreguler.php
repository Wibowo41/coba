<H5 style="color: grey;">Transaksi / Reject Reguler</H5>
    ...
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Basic form</h4>
            <input type="hidden" id="kategori" value="40">
            <div class="row">
                ...
                <div class="form-group row">
                    ...
                    <select class="form-control" name="status" id="identifikasi" style="background-color: #FFF0F5;">
                      <option value=""></option>
                      <?php
                        $query= Yii::app()->db->createCommand("SELECT * FROM master_kategori_identifikasi mki LEFT JOIN master_identifikasi mi ON mki.kode_identifikasi = mi.kode_identifikasi WHERE mki.kode_kategori = 'RJRG'")->queryAll();
                        $array=array();
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped">
                      ...
                      <tbody>
                        <?php
                            $query= Yii::app()->db->createCommand("SELECT * FROM transaksi tr LEFT JOIN master_identifikasi mi ON tr.identifikasi = mi.kode_identifikasi LEFT JOIN master_bagian mb ON tr.bagian_proses = mb.code_master_proses WHERE DATE(tr.waktu_transaksi) = CURRENT_DATE AND tr.kategori = 'RJRG' ORDER BY tr.id_transaksi DESC")->queryAll();
                            $array=array();
                            foreach($query as $row){
                        ?>
                        <tr>
