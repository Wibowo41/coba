<H5 style="color: grey;">Transaksi / OK Rework</H5>
    ...
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Basic form</h4>
            <input type="hidden" id="kategori" value="15">
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped">
                      ...
                      <tbody>
                        <?php
                            $query= Yii::app()->db->createCommand("SELECT * FROM transaksi tr LEFT JOIN master_bagian mb ON tr.bagian_proses = mb.code_master_proses WHERE DATE(tr.waktu_transaksi) = CURRENT_DATE AND tr.kategori = 'OKRW' ORDER BY tr.id_transaksi DESC")->queryAll();
                            $array=array();
